...
![Image](https://google.com/image.png) and a link here: [Link](https://google.com)
...
'''
        self.maxDiff = None
        self.assertEqual(
            '<div><h1>Title</h1><h2>First Heading</h2><p>This is <b>bolded</b> paragraph</p><p>Another paragraph block, this time with another <i>line</i>.</p><ul><li>Unordered list item 1</li><li>second item</li></ul><pre><code>print("Hello world!")</code></pre><blockquote>this prints "Hello world!"</blockquote><h2>Second Heading</h2><ol><li>first</li><li>second</li></ol><p><img src="https://google.com/image.png" alt="Image"></img> and a link here: <a href="https://google.com">Link</a></p><blockquote>This is a quote and this should be on the same <code>line</code></blockquote></div>',
